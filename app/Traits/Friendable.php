...
trait Friendable {
    ...
    public function add_friend($user_requested_id) {
        // Checks if you're sending a friend request to yourself and returns false
    ...
    // Check that the currently authenticated user is friends with the selected member
